<?php 
    ...
    $today = date("Y-m-d"); 
    $date_t="2019-04-28";
    $url = 'https://nation.com.pk/E-Paper/lahore/'.$date_t.'/page-1'; 
    ...
    for($p=0;$p<count($nop);$p++)
    {
        ...
        for ($j=0; $j < $nod; $j++) {       // 7
            # code...
            $url2 = 'https://nation.com.pk/E-Paper/lahore/'.$date_t.'/page-'.($p+1).'/detail-'.$j;  //1x0
    ...
    function getNoOfPages($url1)
    {
        ...
        for ($i=0; $i < count($result) ; $i++) { 
            ...
            elseif ($result[$i] == 'city') {
                $result[$i] = 'category_metropolitan_lahoreNation';
            }
    ...
    function getNoOfDetail($nop2,$date_t)
    {
        ...
        for ($i=0; $i < 30; $i++) { 
            # code...
            $string_file=file_get_contents('https://nation.com.pk/E-Paper/lahore/'.$date_t.'/page-'.$nop2.'/detail-'.$detail, false, $context);
