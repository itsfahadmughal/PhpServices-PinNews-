...
$date2="2019_04_25";
	...
	if ($i<=7||$i==14) {
		# code...
		uploadNews('category_dawnNational',$title,$image,$content,$date2);       // tablename, title, image, content
	}else if ($i==8) {
		# code...
		uploadNews('category_dawnEditorial',$title,$image,$content,$date2);       // tablename, title, image, content
	}else if ($i==9) {
		# code...
		uploadNews('category_dawnOpinion',$title,$image,$content,$date2);       // tablename, title, image, content
	}
	else if ($i==10||$i==11) {
		# code...
		uploadNews('category_dawnBusiness',$title,$image,$content,$date2);       // tablename, title, image, content
	}else if ($i==12||$i==13) {
		# code...
		uploadNews('category_dawnInternational',$title,$image,$content,$date2);       // tablename, title, image, content
	}else if ($i==15||$i==16||$i==17) {
		# code...
		uploadNews('category_dawnSports',$title,$image,$content,$date2);       // tablename, title, image, content
	}else{
